...
%
fprintf( 'question no 9')
car=input('select your car','s')
day=input('input the number of day you want')
miles=input('enter miles')

if car=='sedan'
    if day>0 & day<7
        charges=day*79
        addchrg=miles-80*day
        if addchrg>0
            total=charges+addchrg*0.69
            cents=(total-floor(total))*100
            fprintf('your total charges are %5.0f dollar and %5.0f cents',total,cents)
        else
            total=charges
            cents=(total-floor(total))*100
            fprintf('your total charges are %5.0f dollar and %5.0f cents',total,cents)
     ...
     elseif day>6 & day<30
        charges=day*69
        addchrg=miles-100*day
        if addchrg>0
            total=charges+addchrg*0.59
            cents=(total-floor(total))*100
            fprintf('your total charges are %5.0f dollar and %5.0f cents',total,cents)
        else
            total=charges
        ...
        charges=day*59
        addchrg=miles-120*day
        if addchrg>0
            total=charges+addchrg*0.49
            cents=(total-floor(total))*100
            fprintf('your total charges are %5.0f dollar and %5.0f cents',total,cents)
        else
            total=charges
